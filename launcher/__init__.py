...
The modules form one chain, cli -> stack -> images -> upstream -> core, and read each other by
attribute at call time (`core.RUNTIME`, `images.read_manifest()`) rather than importing names,
